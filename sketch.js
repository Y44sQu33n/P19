...
function preload(){
  //forestImg = loadImage("ground1.png")
  
  trex_running = loadAnimation("fairy1.png","fairy2.png");
  trex_collided = loadAnimation("fairy_die.png");
...
function setup() {
 ...
 console.log(message)
  ...
  obstacle4.setCollider("rectangle",0,0,obstacle4.width,obstacle4.height)
  obstacle5.setCollider("rectangle",0,0,obstacle5.width,obstacle5.height)
  obstacle6.setCollider("rectangle",0,0,obstacle6.width,obstacle6.height)*/
